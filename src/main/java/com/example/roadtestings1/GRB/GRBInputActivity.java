...
import com.example.roadtestings1.Gradation.Gradation_5.Gradation5OutputActivity;
...
public class GRBInputActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    x2 = findViewById(R.id.input45_00);
    x3 = findViewById(R.id.input22_40);
    x4 = findViewById(R.id.input11_20);
    x5 = findViewById(R.id.input4_75);
    x6 = findViewById(R.id.input2_36);
    x7 = findViewById(R.id.input600);
    x8 = findViewById(R.id.input75);
    x9 = findViewById(R.id.inputPan);
    ...
    calculate.setOnClickListener(v -> {
      ...
      if (TextUtils.isEmpty(x1.getText().toString()) ||
        ...
        Intent intent = new Intent(getApplicationContext(), GRBOutputActivity.class);
